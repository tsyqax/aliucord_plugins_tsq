...
description = "Just Add button plugin install when not support's channel" // Plugin description that will be shown to user

aliucord {
    // Changelog of your plugin
    changelog.set(
        """
		### NOTE: this has bug when long press on link, but I won't fix at least now
		
        # 1.0.0
        * IPR!
		    * Someone of aliucord staff may dislike this

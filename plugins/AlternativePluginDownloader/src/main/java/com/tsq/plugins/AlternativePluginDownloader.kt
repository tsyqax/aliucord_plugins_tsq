/*
 * This file was extracted from Aliucord Coreplugin and modified.
 * Copyright (c) 2021 Juby210 & Vendicated
 * Licensed under the Open Software License version 3.0
 */

package com.tsq.AlternativePluginDownloader
...
@AliucordPlugin
class AlternativePluginDownloader : Plugin() {
    val isRequired2 = false // TODO: make this optional once PluginRepo is core
    ...
    override fun start(context: Context) {
        ...
        patcher.after<WidgetChatListActions>(
            ...
            entries.firstOrNull()?.let { firstEntry ->
				layout.addView(firstEntry, replyViewIdx)
			}
        }
        ...
        patcher.after<WidgetUrlActions>("onViewCreated", View::class.java, Bundle::class.java) {
            ...
            entries.firstOrNull()?.let { firstEntry ->
				layout.addView(firstEntry, copyViewIdx)
			}
        }
    }
    ...
    private fun shouldScanForPlugins(message: Message, authorMember: GuildMember? = null): Boolean {
        return when (message.channelId) {
            ...
            Constants.PLUGIN_DEVELOPMENT_CHANNEL_ID -> false
			
			Constants.SUPPORT_CHANNEL_ID,
			Constants.PLUGIN_SUPPORT_CHANNEL_ID,
			Constants.BOT_SPAM_CHANNEL_ID -> false
